...
public class HotelListFragment extends Fragment implements ItemClickListener{
    ...
    List<HotelListResponse> userListResponseData;

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        // Inflate the layout for this fragment
        view = inflater.inflate(R.layout.hotellist_fragment, container, false);
        return view;
    }
...
//        HotelAdapter hotelListAdapter = new HotelAdapter(getActivity(), hotelListData);
//        recyclerView.setAdapter(hotelListAdapter);
    ...
    private void getHotelsListsData() {
        ...
        Api.getClient().getHotelsLists(new Callback<List<HotelListResponse>>() {
            @Override
            public void success(List<HotelListResponse> userListResponses, Response response) {
    ...
    private void setupRecyclerView() {
        ...
        RecyclerView recyclerView = view.findViewById(R.id.hotel_list_recyclerView);
        recyclerView.setLayoutManager(new LinearLayoutManager(getActivity()));
        HotelAdapter hotelListAdapter = new HotelAdapter(getActivity(), userListResponseData);
        recyclerView.setAdapter(hotelListAdapter);
    ...
    public void onClick(View view, int position) {
        HotelListResponse hotelListData = userListResponseData.get(position);

        String hotelName = hotelListData.getHotel_name();
        String price = hotelListData.getRoom_price().toString();
        String availability = "true";

        //to pass data from one screen to other
        Bundle bundle = new Bundle();
        bundle.putString("hotel name", hotelName);
        bundle.putString("hotel price", price);
        System.out.println("&&&&&&&&&& -> " + hotelListData.getHotel_id().toString());
        bundle.putString("hotel id", hotelListData.getHotel_id().toString()); // hotel Id
        ...
        guestDetailsFragment hotelGuestDetailsFragment = new guestDetailsFragment();
